...
no_missing()
{
    msg "pc-missing base vim should produce no output"
    export_set vim base
...
missing_vim()
{
    msg "pc-missing vim base should produce some output"
    export_set vim base
...
print_missing_leaf()
{
    msg "pc-missing-leaves vim base should ouptput vim-minimal"
    export_set vim base
...
no_missing_leaves()
{
    msg "pc-missing-leaves base vim should produce no output"
    export_set vim base
